...
export default class TenantRegistration extends React.Component{
    constructor(props)
    {
        super(props);
        this.state={
    ...
    render(){
        return(
            ...
            <div className="container-fluid" onChange={this.onChangeValue}>
                <h1 style={{color:'floralwhite'}}><b> Tenant Registration Form</b></h1>
                
                
                <form className="RegForm" onSubmit={this.submitForm}>
