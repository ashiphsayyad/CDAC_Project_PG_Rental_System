...
export default class TenantProfile extends React.Component{
    ...
    componentDidMount = () =>{
        fetch("http://localhost:8080/getTenant/"+this.state.tid)
        .then(resp => resp.json())
            ...
            <div className="container-fluid">
                ...
                <form className="RegForm" style={{padding: '50px 50px 50px 50px',
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" id="tfname" ref="tfname" onChange={this.handleChnage} name="tfname" className="form-control"  value={this.state.tenant.lname} ></input>
                            </div>

                            <div className="form-group">
                                <label style={{color:'lightcoral'}} for="tlname" style={{textAlign:'left'}}><b>Last Name</b></label>
                                <input type="text" id="tlname" ref="tlname" onChange={this.handleChnage} name="tlname" className="form-control"   value={this.state.tenant.fname} ></input>
                            </div>

                            <div className="form-group">
                                <label style={{color:'lightcoral'}} for="temailid" style={{textAlign:'left'}}><b>Email ID</b></label>
                                <input type="text" id="temailid" ref="temailid" onChange={this.handleChnage} name="temailid" className="form-control"   value={this.state.tenant.user_id.email_id} ></input>
                            </div>
                    
                            <div className="form-group">
                                <label style={{color:'lightcoral'}} for="temailid" style={{textAlign:'left'}}><b>User Type</b></label>
                                <input type="text" id="temailid" ref="temailid" onChange={this.handleChnage} name="temailid" className="form-control"   value={this.state.tenant.user_id.user_type} ></input>
                            </div>
